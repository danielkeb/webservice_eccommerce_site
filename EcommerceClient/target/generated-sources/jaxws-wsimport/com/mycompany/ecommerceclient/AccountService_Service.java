 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://soapapi/", wsdlLocation = "http://it-lab-6pc-8:8080/EcommerceSite/AccountService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://soapapi/", "AccountService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://it-lab-6pc-8:8080/EcommerceSite/AccountService?WSDL");
    ...
    public AccountService getAccountServicePort() {
        return super.getPort(new QName("http://soapapi/", "AccountServicePort"), AccountService.class);
    }
    ...
    public AccountService getAccountServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapapi/", "AccountServicePort"), AccountService.class, features);
    }
